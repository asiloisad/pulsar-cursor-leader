...
- `cursor-leader:power-global`: <kbd>Cmd/Ctrl+Alt+Insert</kbd> toggle power mode for all editors,
- `cursor-leader:power-editor`: <kbd>Cmd/Ctrl+Shift+Alt+Insert</kbd> toggle power mode for the active editor,
- `cursor-leader:toggle`: <kbd>Cmd/Ctrl+Alt+Enter</kbd> toggle cursor instance,
- `cursor-leader:previous`: <kbd>Cmd/Ctrl+Alt+PageUp</kbd> activate next cursor,
- `cursor-leader:next`: <kbd>Cmd/Ctrl+Alt+PageDown</kbd> activate previous cursor,
- `cursor-leader:reset`,
- `cursor-leader:remove`,
- `cursor-leader:move-up`: <kbd>Cmd/Ctrl+Alt+Up</kbd>,
- `cursor-leader:move-down`: <kbd>Cmd/Ctrl+Alt+Down</kbd>,
- `cursor-leader:move-left`: <kbd>Cmd/Ctrl+Alt+Left</kbd>,
- `cursor-leader:move-right`: <kbd>Cmd/Ctrl+Alt+Right</kbd>,
